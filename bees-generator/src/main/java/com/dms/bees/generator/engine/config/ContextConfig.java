package com.dms.bees.generator.engine.config;
...
public class ContextConfig {
    ...
    private String templatePrefixPath = "beesTemplate/advanced";
    private String projectPath = "D:\\ideaSpace\\bees";//模板输出的项目目录
    ...
    private String proPackage = "com.dms.bees.admin";
    private String coreBasePackage = "com.dms.bees.core";
    private String modelPackageName = "com.dms.bees.modular.system.model";        //model的包名
    private String modelMapperPackageName = "com.dms.bees.modular.system.dao";    //model的dao
