 ...
 */
public class BeesGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void dataSourceConfig() {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://127.0.0.1:3306/bees?characterEncoding=utf8");
    }
    ...
    protected void packageConfig() {
        ...
        packageConfig.setEntity("com.dms.bees.admin.common.persistence.model");
        packageConfig.setMapper("com.dms.bees.admin.common.persistence.dao");
        packageConfig.setXml("com.dms.bees.admin.common.persistence.dao.mapping");
    }

    protected void contextConfig() {
        contextConfig.setProPackage("com.dms.bees.admin");
        contextConfig.setCoreBasePackage("com.dms.bees.core");
        contextConfig.setBizChName("字典管理");
        contextConfig.setBizEnName("sysDict");
        contextConfig.setModuleName("system");
        contextConfig.setProjectPath("D:\\ideaSpace\\bees\\bees-admin");//写自己项目的绝对路径
