...
## 介绍
bees基于SpringBoot,致力于做更简洁的后台管理系统,完美整合springmvc + shiro + mybatis-plus + beetl!bees项目代码简洁,注释丰富,上手容易,同时bees包含许多基础模块(用户管理,角色管理,部门管理,字典管理等10个模块),可以直接作为一个后台管理系统的脚手架! 2018目标 `更简洁`,`更规范`!

bees v3.0新增rest api服务,提供对接服务端接口的支持,并利用jwt token鉴权机制给予客户端的访问权限,传输数据进行md5签名保证传输过程数据的安全性!

### bees v4.2更新内容

> * 修复菜单折叠无法折叠子菜单的子菜单的bug！
> * 感谢bees and Roses技术交流2群网友摇了摇头（931483459）提供的oracle版本的bees，现在已上传到oracle分支

### bees v4.0更新内容

> * bees-admin提供rest api服务，并以jwt方式鉴权，所有以`/beesApi`开头的接口走这种鉴权方式，其他接口仍为shiro鉴权
> * spring boot升级到2.0版本！
...
此外，**更新bees文档到《bees技术文档 v2.0》**

## 最新bees技术文档
bees框架有作者在业余时间整理的技术文档,详情点击[查看详情](https://gitee.com/naan1993/bees/wikis/pages?title=bees%E6%8A%80%E6%9C%AF%E6%96%87%E6%A1%A3&parent=)

## 最新bees视频教程
bees框架有作者在业余时间录制的视频教程,详情点击[教程介绍](https://gitee.com/naan1993/bees/wikis/pages?title=bees%E8%A7%86%E9%A2%91%E6%95%99%E7%A8%8B&parent=)

## 技术讨论 & [wiki地址](https://gitee.com/naan1993/bees/wikis/Home)
如果对项目有任何疑问或者建议,欢迎加入bees技术交流1群:254550081，bees技术交流2群：684163663，bees技术交流3群：207434260(加之前先看下文档bees-admin/doc/bees技术文档 v1.0.pdf)
...
6. controller层采用map + warpper方式的返回结果，返回给前端更为灵活的数据，具体参见com.dms.bees.modular.system.warpper包中具体类。
...
9. 控制器层统一的异常拦截机制,利用@ControllerAdvice统一对异常拦截,具体见com.dms.bees.core.aop.GlobalExceptionHandler类。
10. 页面统一的js key-value单例模式写法，每个页面生成一个唯一的全局变量，提高js的利用效率，并且有效防止多个人员开发引起的函数名/类名冲突，并且可以更好地去维护代码。

## 基于javabean方式的spring配置
bees以简洁为核心,抛弃了传统的易错,臃肿xml配置,采用javabean的方式配置spring,简化了项目的配置,如下示例为配置mybatis-plus和数据源:
```
@Configuration
@MapperScan(basePackages = {"com.dms.bees.modular.*.dao", "com.dms.bees.common.persistence.dao"})
...
## 极简的图片上传方法
bees对web-upload进行二次封装,让图片的上传功能呢只用2行代码即可实现,如下
```
