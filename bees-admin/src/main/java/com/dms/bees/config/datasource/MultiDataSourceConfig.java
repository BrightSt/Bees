package com.dms.bees.config.datasource;

import com.alibaba.druid.pool.DruidDataSource;
import com.baomidou.mybatisplus.plugins.OptimisticLockerInterceptor;
import com.baomidou.mybatisplus.plugins.PaginationInterceptor;
import com.dms.bees.core.config.properties.DruidProperties;
import com.dms.bees.core.config.properties.MutiDataSourceProperties;
import com.dms.bees.core.datascope.DataScopeInterceptor;
import com.dms.bees.core.mutidatasource.DynamicDataSource;
import com.dms.bees.core.mutidatasource.aop.MultiSourceExAop;
 ...
 */
@Configuration
@ConditionalOnProperty(prefix = "bees.muti-datasource", name = "open", havingValue = "true")
@EnableTransactionManagement(order = 2)
@MapperScan(basePackages = {"com.dms.bees.modular.*.dao","com.dms.bees.multi.mapper"})
public class MultiDataSourceConfig {

    @Bean
    @ConfigurationProperties(prefix = "bees.muti-datasource")
    ...
    public DynamicDataSource mutiDataSource(DruidProperties druidProperties, MutiDataSourceProperties mutiDataSourceProperties) {
        ...
        DruidDataSource dataSourcebees = dataSource(druidProperties);
        ...
        hashMap.put(mutiDataSourceProperties.getDataSourceNames()[0], dataSourcebees);
        hashMap.put(mutiDataSourceProperties.getDataSourceNames()[1], bizDataSource);
        dynamicDataSource.setTargetDataSources(hashMap);
        dynamicDataSource.setDefaultTargetDataSource(dataSourcebees);
